 ...
 * HISTORY
 * $Log: device_init.c,v $
 * Revision 2.14.1.2  1993/11/11  22:26:32  menze
 * Added third argument to x-kernel initialization call
 *
 * Revision 2.14.1.1  1993/09/22  20:57:37  menze
 * added hook to initialize the x-kernel
 *
...
device_service_create()
{
	 ...
	 */
#ifdef XKMACHKERNEL	
	(void) kernel_thread(kernel_task, xkInit, 0);
#endif XKMACHKERNEL	
}
