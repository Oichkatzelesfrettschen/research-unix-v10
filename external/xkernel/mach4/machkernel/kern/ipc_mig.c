 ...
 * HISTORY
 * $Log: ipc_mig.c,v $
 * Revision 2.21.1.2  1993/09/21  21:06:24  menze
 * Changed symbol on which the x-kernel mods are compiled to XK_PROXY
 *
 * Revision 2.21.1.1  1993/09/20  22:19:25  menze
 * Enabled mach_msg_rpc_from_kernel for x-kernel
 *
...
#endif	NORMA_VM || defined(XK_PROXY)
