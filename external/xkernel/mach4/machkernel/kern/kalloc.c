 ...
 * HISTORY
 * $Log: kalloc.c,v $
 * Revision 2.11.1.1  1993/09/22  21:12:20  menze
 * allocation numbers for various block sizes were changed to
 * support the message tool and x-kernel input buffers (ho & rcs)
 *
