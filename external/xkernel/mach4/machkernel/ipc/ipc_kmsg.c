 ...
 * HISTORY
 * $Log: ipc_kmsg.c,v $
 * Revision 2.30.1.2  1993/09/21  21:00:35  menze
 * Changed symbol on which the x-kernel mods are compiled to XK_PROXY
 *
 * Revision 2.30.1.1  1993/09/20  22:42:20  menze
 * Enabled ipc_kmsg_copyout_to_kernel conditioned on presence of the
 * x-kernel
 *
...
#if	NORMA_IPC || NORMA_VM || defined(XK_PROXY)
/*
...
#endif	NORMA_IPC || NORMA_VM || defined(XK_PROXY)
