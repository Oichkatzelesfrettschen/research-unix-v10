 ...
 * HISTORY
 * $Log: ipc_kobject.c,v $
 * Revision 2.15.1.2  1993/09/21  21:03:19  menze
 * Changed symbol on which the x-kernel mods are compiled to XK_PROXY
 *
 * Revision 2.15.1.1  1993/09/20  22:34:39  menze
 * Modified dispatcher to dispatch kernel-port xkernel UPROXY MIG
 * messages to the in-kernel xkernel.
 *
 *
...
#ifdef	XK_PROXY
	 || (routine = xk_uproxy_server_routine(&request->ikm_header)) != 0
#endif  
	) {
