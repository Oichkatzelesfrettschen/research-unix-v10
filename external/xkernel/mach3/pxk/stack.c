 ...
 * HISTORY
 * $Log: stack.c,v $
 * Revision 2.14.1.1  1993/12/01  18:46:44  menze
 * Applied UofAz small-stack modification to the MK82 version
 *
...
stack_init(cproc_t p)
{
	...
	/* UofA hack to prevent grossly large stacks ... */
	if (cthread_stack_size > 8 * 8192) cthread_stack_size = 8 * 8192;
