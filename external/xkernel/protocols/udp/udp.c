...
static int		getPorts( PSTATE *, Part *, UDPport *, UDPport *,
				  char * );
...
static xkern_return_t	udpDemux( XObj, XObj, Msg * );
...
static xkern_return_t	udpOpenDisable( XObj, XObj, XObj, Part * );
static xkern_return_t	udpOpenEnable( XObj, XObj, XObj, Part * );
static xkern_return_t	udpOpenDisableAll( XObj, XObj );
static xkern_return_t	udpPop( XObj, XObj, Msg *, void * );
...
static xkern_return_t	udpCloseProtl();
static xkern_return_t	udpCloseSessn();
static int		udpControlProtl() ;
static int		udpControlSessn() ;
static XObj		udpCreateSessn();
static xkern_return_t	udpDemux();
static long		udpHdrLoad();
static void		udpHdrStore();
static XObj		udpOpen();
static xkern_return_t	udpOpenDisable();
static xkern_return_t	udpOpenEnable();
static xkern_return_t	udpOpenDisableAll();
static xkern_return_t	udpPop();
